export const library = {
    ...
    lastId() {
        let allId = this.books.map((book) => book.id);
    ...
    findBookByTitle(titleBook) {
        let index = this.books.findIndex((book) => book.title === titleBook);
        return this.books[index];
        
    },

    update(bookToUpdate) {
        let index = this.books.findIndex(book => book.id === bookToUpdate.id);
